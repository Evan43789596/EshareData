...
<body>
   <ul  class="nav nav-tabs">
   	<li class="active"><a href="#">更新入册</a></li>
   </ul>
   
   <div class="div1">
       <form action="" id="formid"> 
            <div> <input type="hidden" name="id" value="${girls.id }"></div>
	        <div>	          
	        ...
	        <div class="button">
	           <button type="button" class="btn btn-primary btn-lg" style="font-size: 26px" onclick="doupdate()">
	           <span class="glyphicon glyphicon-user">更新入册</span>
	           </button>
	        </div>
       </form>
